...
// DEQUEUE. Dequeue and return the object with highest rank (smallest rank number).
    ...
    public Base dequeue()
    {
        ...
        // No higher rank on the right, return the first object available.
        else if (root.right == null) 
        {
            Node temp = root;
            if (root.left != null) // Still have less-or-equal ranked objects on the left.
            {
                root = root.left;
            }
            else // No more object left.
            {
                root = null;
            }
            return temp.object;
        }
         // Have higher ranked object on the right.
        else
        {
            Node above = root;
            Node below = above.right;
